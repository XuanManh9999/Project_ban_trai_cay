# Generated by Django 5.0.6 on 2024-06-25 05:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='GioHang',
            fields=[
                ('id_gio_hang', models.AutoField(db_column='ID_gio_hang', primary_key=True, serialize=False)),
                ('so_luong', models.IntegerField(blank=True, null=True)),
                ('ngay_them', models.DateTimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            name='LoaiSanPham',
            fields=[
                ('id_san_pham', models.OneToOneField(db_column='ID_san_pham', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='home.sanpham')),
